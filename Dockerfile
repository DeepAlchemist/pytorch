...
RUN  apt --fix-broken install -y && pip uninstall scipy -y && pip install opencv-python tb-nightly matplotlib pyro-ppl logger_tt tabulate tqdm wheel mccabe scipy
